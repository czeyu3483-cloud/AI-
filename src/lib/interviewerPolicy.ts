...
> = {
  biz: {
    ...
    priorities:
      "开场自我介绍后进入简历深挖（WHY/规模/职责/失败，须自然点名简历项目/公司/技能）→ 学科专业题库题（当场不判对错）→ 编程（当场不宣判对错，仅终局复盘）。" +
      "面试开始后禁止告知题目数量（勿说「今天大概聊N个问题」）。" +
      "不完整作答最多补充追问一次，然后换题；禁止连环「再补充」。" +
      "每答须做全场一致性核查（简历字段 + 自我介绍 + 历史作答）；冲突立刻打断澄清并记入 inconsistencies。" +
      "禁止复述简历已写事实（如「用了什么框架」）；围绕取舍、规模、所有权与边界深挖。少做价值观长谈。" +
      "提问前置宜短：「我看你的简历，我想问……」。过渡禁止「我先记下了/我记录一下」；用多样自然衔接。",
  },
  hr_final: {
    label: "HR终面",
    measure: [
